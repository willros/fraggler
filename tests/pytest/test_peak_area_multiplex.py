...
def test_peak_model(pam):
    ...
    assert round(voigt.fitted_peak_height.to_list()[0], 2) == 731.83
    assert round(gauss.fitted_peak_height.to_list()[0], 2) == 708.33
    ...
    assert round(gauss.area.to_list()[0], 2) == 3117.44
    assert round(voigt.area.to_list()[0], 2) == 3705.64
